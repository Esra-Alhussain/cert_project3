...
const EditQuiz = ({ quiz, setQuizData ,handleQuestionTextChange, handleAddQuestion, deleteQuestion, questionIndexes, handleAddName, handleAnswerTextChange, saveQuiz}) => {
    console.log(`message quiz:${quiz}`)
    return(
